...
;;
;; The below is a very mildly modified version of 
;; the implementation from [here](http://hcsw.org/downloads/isaac.lisp)
;; Just re-packaging and removing a test output function.
;;   -Inaimathi
;;
